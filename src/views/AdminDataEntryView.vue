...
import { createUserPaper, saveResponsesPaper } from '@/lib/supabase'
...
<template>
  <div>
    <div class="flex items-center justify-between mb-6">
      <div>
        <h2 class="text-xl font-bold text-neutral-800">Entrada de Datos</h2>
        <p class="text-neutral-500 text-sm">Exámenes en papel</p>
      </div>
    </div>
