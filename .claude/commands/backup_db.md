...
2. For each table (users_online, responses_online, users_paper, responses_paper, responses_play_random, feedback, logs_download), fetch all rows via the Supabase REST API and save to `backups/{table}_{YYYY-MM-DD_HHmmss}.csv`
